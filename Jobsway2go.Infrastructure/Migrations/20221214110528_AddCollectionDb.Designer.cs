...
namespace Jobsway2go.Infrastructure.Migrations
{
    ...
    [Migration("20221214110528_AddCollectionDb")]
    partial class AddCollectionDb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jobsway2go.Core.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Jobsway2go.Core.Models.JobCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Jobsway2go.Core.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Jobsway2go.Core.Models.Section", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Jobsway2go.Core.Models.Role", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Jobsway2go.Core.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
